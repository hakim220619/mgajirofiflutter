...
import 'package:flutmgaji/gaji/GajiById.dart';
...
class ListUserGaji extends StatefulWidget {
  const ListUserGaji({
    Key? key,
  }) : super(key: key);

  @override
  State<ListUserGaji> createState() => _ListUserGajiState();
}

List _listsData = [];

class _ListUserGajiState extends State<ListUserGaji> {
                ...
                ListTile(
                  onTap: (){
                    Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => GajiById(id: _listsData[index]['id'].toString())));
                  },
                title: Text(
