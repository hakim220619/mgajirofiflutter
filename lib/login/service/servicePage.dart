...
class HttpService {
  ...
  static login(email, password, context) async {
    ...
    if (response.statusCode == 200) {
      ...
      await pref.setString("full_name", Users['userData']['name'].toString());
      await pref.setString("role", Users['userData']['role'].toString());
      await pref.setString("phone", Users['userData']['notlp'].toString());
      await pref.setString("status", Users['userData']['status'].toString());
      await pref.setString("address", Users['userData']['alamat'].toString());
